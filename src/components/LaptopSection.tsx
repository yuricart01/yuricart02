...
export default function LaptopSection() {
  const banners = [
    { id: 1, src: "/images/promotions/laptop_banner.png", href: "/shop?category=laptops" },
    { id: 2, src: "/images/banner1.png", href: "/shop?category=laptops" },
    { id: 3, src: "/images/banner2.png", href: "/shop?category=laptops" },
    { id: 4, src: "/images/banner3.png", href: "/shop?category=laptops" },
    { id: 5, src: "/images/banner4.png", href: "/shop?category=laptops" },
  ];
